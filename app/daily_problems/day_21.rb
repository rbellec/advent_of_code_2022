class Day21
  ...
  def monkey_value(name)
    ...
    existing_value = monkey_definitions.dig(name, :value)
    ...
    # Not: infinite loop in cycles in monkey definitions.
    monkey_value = case monkey[:operator]
    when "+"
  ...
  def problem_2
    ...
    solution = (real - complex.real) / complex.imaginary
  end
